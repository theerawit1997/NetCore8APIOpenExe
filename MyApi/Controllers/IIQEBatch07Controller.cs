...
namespace MyApi.Controllers
{
    ...
    [ApiController]
    public class IIQEBatch07Controller : Controller
    {
        private const string LogFilePath = @"C:\LogFileOpenExe\log.txt";

        [HttpGet]
        public IActionResult IIQEBatch07()
        {
            try
            {
                // Log or return message indicating work started
                //Console.WriteLine("IIQEBatch01!!");
                LogMessage("IIQEBatch07!!");
                string exePath = @"C:\inetpub\wwwroot\IIQE Batch\07 IIQE_TRANSFER_C_EXAM_ROUND_TO_AG\IIQE_TRANSFER_C_EXAM_ROUND_TO_AG.exe";
