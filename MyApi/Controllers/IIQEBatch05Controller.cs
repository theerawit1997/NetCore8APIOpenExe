...
namespace MyApi.Controllers
{
    ...
    [ApiController]
    public class IIQEBatch05Controller : Controller
    {
        private const string LogFilePath = @"C:\LogFileOpenExe\log.txt";

        [HttpGet]
        public IActionResult IIQEBatch05()
        {
            try
            {
                // Log or return message indicating work started
                //Console.WriteLine("IIQEBatch01!!");
                LogMessage("IIQEBatch05!!");
                string exePath = @"C:\inetpub\wwwroot\IIQE Batch\05 C_Exam_Result_Transfer_Process\C_Exam_Result_Transfer_Process.exe";
