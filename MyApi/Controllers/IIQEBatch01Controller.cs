...
namespace MyApi.Controllers
{
    ...
    [ApiController]
    public class IIQEBatch01Controller : Controller
    {
        private const string LogFilePath = @"C:\LogFileOpenExe\log.txt";

        [HttpGet]
        public IActionResult IIQEBatch01()
        {
            try
            {
                // Log or return message indicating work started
                //Console.WriteLine("IIQEBatch01!!");
                LogMessage("IIQEBatch01!!");
                string exePath = @"C:\inetpub\wwwroot\IIQE Batch\01 P_Exam_Seat_Number_Process\P_Exam_Seat_Number_Process.exe";
