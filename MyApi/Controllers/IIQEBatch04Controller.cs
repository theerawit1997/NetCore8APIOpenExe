...
namespace MyApi.Controllers
{
    ...
    [ApiController]
    public class IIQEBatch04Controller : Controller
    {
        private const string LogFilePath = @"C:\LogFileOpenExe\log.txt";

        [HttpGet]
        public IActionResult IIQEBatch04()
        {
            try
            {
                // Log or return message indicating work started
                //Console.WriteLine("IIQEBatch01!!");
                LogMessage("IIQEBatch04!!");
                string exePath = @"C:\inetpub\wwwroot\IIQE Batch\04 P_Exam_Result_Transfer_Process\P_Exam_Result_Transfer_Process.exe";
