...
namespace MyApi.Controllers
{
    ...
    [ApiController]
    public class IIQEBatch09Controller : Controller
    {
        private const string LogFilePath = @"C:\LogFileOpenExe\log.txt";

        [HttpGet]
        public IActionResult IIQEBatch09()
        {
            try
            {
                // Log or return message indicating work started
                //Console.WriteLine("IIQEBatch01!!");
                LogMessage("IIQEBatch09!!");
                string exePath = @"C:\inetpub\wwwroot\IIQE Batch\09 Lookup_Data_From_OIC_API\Lookup_Data_From_OIC_API.exe";
