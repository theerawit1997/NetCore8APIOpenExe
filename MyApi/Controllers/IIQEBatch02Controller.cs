...
namespace MyApi.Controllers
{
    ...
    [ApiController]
    public class IIQEBatch02Controller : Controller
    {
        private const string LogFilePath = @"C:\LogFileOpenExe\log.txt";

        [HttpGet]
        public IActionResult IIQEBatch02()
        {
            try
            {
                // Log or return message indicating work started
                //Console.WriteLine("IIQEBatch01!!");
                LogMessage("IIQEBatch02!!");
                string exePath = @"C:\inetpub\wwwroot\IIQE Batch\02 IIQE_SEND_P_EXAM_ROUND\IIQE_SEND_P_EXAM_ROUND.exe";
